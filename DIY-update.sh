...
wget https://git.jdcook.eu.org/https://raw.githubusercontent.com/nsv2051/MRI/main/task_before.sh -o task_before.log -O /ql/data/config/task_before.s.sh
...
wget https://git.jdcook.eu.org/https://raw.githubusercontent.com/nsv2051/MRI/main/config_sample.sh -o config_sample.log -O /ql/data/config/config.s.sh
...
wget https://git.jdcook.eu.org/https://raw.githubusercontent.com/nsv2051/MRI/main/code.sh -o code.log -O /ql/data/config/code.s.sh
...
wget https://git.jdcook.eu.org/https://raw.githubusercontent.com/nsv2051/MRI/main/extra.sh -o extra.log -O /ql/data/config/extra.s.sh
echo "5.自动更新extra2.sh模板"
# curl -L https://cdn.jsdelivr.net/gh/shuai2051/MRI@main/extra2.sh -o /ql/data/scripts/extra2.sh
wget https://git.jdcook.eu.org/https://raw.githubusercontent.com/nsv2051/MRI/main/extra2.sh -o extra2.log -O /ql/data/scripts/extra2.sh
echo "6.自动下载ckck2.sh文件"
# curl -L https://cdn.jsdelivr.net/gh/shuai2051/MRI@main/ckck2.sh -o /ql/data/scripts/ckck2.sh
wget https://git.jdcook.eu.org/https://raw.githubusercontent.com/nsv2051/MRI/main/ckck2.sh -o ckck2.log -O /ql/data/scripts/ckck2.sh
echo "7.自动下载notify2.sh文件"
wget https://git.jdcook.eu.org/https://raw.githubusercontent.com/nsv2051/MRI/main/notify2.sh -o notify2.log -O /ql/data/scripts/notify2.sh
echo "配置完毕"
