...
wget https://git.nsv.workers.dev/https://raw.githubusercontent.com/nsv2051/MRI/main/task_before.sh -o task_before.log -O /ql/data/sample/task_before.s.sh && cp -rf /ql/data/sample/task_before.s.sh /ql/data/config
...
wget https://git.nsv.workers.dev/https://raw.githubusercontent.com/nsv2051/MRI/main/config_sample.sh -o config_sample.log -O /ql/data/sample/config.s.sh && cp -rf /ql/data/sample/config.s.sh /ql/data/config
...
wget https://git.nsv.workers.dev/https://raw.githubusercontent.com/nsv2051/MRI/main/code.sh -o code.log -O /ql/data/sample/code.s.sh && cp -rf /ql/data/sample/code.s.sh /ql/data/config
...
wget https://git.nsv.workers.dev/https://raw.githubusercontent.com/nsv2051/MRI/main/extra.sh -o extra.log -O /ql/data/sample/extra.s.sh && cp -rf /ql/data/sample/extra.s.sh /ql/data/config
