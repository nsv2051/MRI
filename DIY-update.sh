...
wget https://git.nsv.workers.dev/https://raw.githubusercontent.com/nsv2051/MRI/main/task_before.sh -o task_before.log -O /ql/sample/task_before.s.sh && cp -rf /ql/sample/task_before.s.sh /ql/config
...
wget https://git.nsv.workers.dev/https://raw.githubusercontent.com/nsv2051/MRI/main/config_sample.sh -o config_sample.log -O /ql/sample/config.s.sh && cp -rf /ql/sample/config.s.sh /ql/config
...
wget https://git.nsv.workers.dev/https://raw.githubusercontent.com/nsv2051/MRI/main/code.sh -o code.log -O /ql/sample/code.s.sh && cp -rf /ql/sample/code.s.sh /ql/config
...
wget https://git.nsv.workers.dev/https://raw.githubusercontent.com/nsv2051/MRI/main/extra.sh -o extra.log -O /ql/sample/extra.s.sh && cp -rf /ql/sample/extra.s.sh /ql/config
echo "5.自动更新extra2.sh模板"
# curl -L https://cdn.jsdelivr.net/gh/shuai2051/MRI@main/extra2.sh -o /ql/scripts/extra2.sh
wget https://git.nsv.workers.dev/https://raw.githubusercontent.com/nsv2051/MRI/main/extra2.sh -o extra2.log -O /ql/scripts/extra2.sh
