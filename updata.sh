...
curl -L https://cdn.jsdelivr.net/gh/shuai2051/MRI@main/updata.sh -o /ql/sample/code.s.sh && cp -rf /ql/sample/code.s.sh /ql/config
...
curl -L https://cdn.jsdelivr.net/gh/shuai2051/MRI@main/extra2.sh -o /ql/scripts/extra2.s.sh && cp -rf /ql/scripts/extra2.s.sh /ql/scripts
